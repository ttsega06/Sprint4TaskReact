  ...
  return (
    <div id="subject-page" data-key="subject" class="grid grid-cols-2">
      <header class="modal-rounded">
        ...
        >
          <a class="underline">Common plant-name:</a>{" "}
          {name + " \n\n" ?? "name not found "}
          <a class="underline">Genus:</a>{" "}
          {type ?? (
            <Text style={{ color: "red" }}>{"Information Not Available"}</Text>
          )}
        </Text>
      </header>
      <div class="modal-body rounded">
        <img
          src={imageSrc}
          alt={imageAlt}
          class="border-8 border-sky-500 hover:border-double rounded"
        />
        <p class="border-primary rounded">{/* <BarChart /> */}</p>
      </div>
      <div>
        ...
        <section className="table" class="table-fixed">
          <table
            class="modal-bodyborder-collapse 
